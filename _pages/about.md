...
---
It's me, Bowen! A junior in Computer Science at the University of Michigan, I am very fortunate to research Natural Language Processing (NLP) and Computational Social Science (CSS) with [Dallas Card](https://dallascard.github.io/), [David Jurgens](https://jurgens.people.si.umich.edu/), and [Rada Mihalcea](https://en.wikipedia.org/wiki/Rada_Mihalcea). I am also grateful to the mentorship of [Benjamin Litterer](https://twitter.com/BenLitterer) and [Siyang Liu](https://scholar.google.com/citations?user=2OjUAPUAAAAJ&hl=en). (All names are ordered alphabetically.) You can find more of our amazing research work at [Blablablab](https://blablablab.si.umich.edu/) and [LIT](https://lit.eecs.umich.edu/)! 
